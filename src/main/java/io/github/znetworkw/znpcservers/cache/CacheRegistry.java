...
public final class CacheRegistry {
    ...
    public static final Constructor<?> ENTITY_CONSTRUCTOR = new TypeCache.BaseCache.ConstructorLoader(
            new TypeCache.CacheBuilder(CachePackage.MINECRAFT_SERVER)
                    .withCategory(CacheCategory.PACKET)
    ...
    public static final Field DATA_WATCHER_REGISTER_ENUM_FIELD = new TypeCache.BaseCache.FieldLoader(
            new TypeCache.CacheBuilder(CachePackage.MINECRAFT_SERVER)
                    .withCategory(CacheCategory.PACKET)
                    .withClassName(DATA_WATCHER_REGISTRY)
                    .withFieldName("a")).load();

    public static final Field ADD_PLAYER_FIELD = new TypeCache.BaseCache.FieldLoader(
            new TypeCache.CacheBuilder(CachePackage.MINECRAFT_SERVER)
                    .withCategory(CacheCategory.PACKET)
                    .withClassName("PacketPlayOutPlayerInfo$EnumPlayerInfoAction")
                    .withFieldName(Utils.BUKKIT_VERSION > 16 ? "a" : "ADD_PLAYER")).load();

    public static final Field REMOVE_PLAYER_FIELD = new TypeCache.BaseCache.FieldLoader(
            new TypeCache.CacheBuilder(CachePackage.MINECRAFT_SERVER)
                    .withCategory(CacheCategory.PACKET)
                    .withClassName("PacketPlayOutPlayerInfo$EnumPlayerInfoAction")
    ...
    public static final Field ENUM_TAG_VISIBILITY_NEVER = new TypeCache.BaseCache.FieldLoader(
            new TypeCache.CacheBuilder(CachePackage.MINECRAFT_SERVER)
                    .withCategory(CacheCategory.PACKET)
