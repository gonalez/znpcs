package io.github.gonalez.znpcservers.utility.inventory;

import io.github.gonalez.znpcservers.utility.itemstack.ItemStackBuilder;
...
public abstract class ZInventoryPage {
     ...
     *
     * <p>Each row represents 9 slots for a inventory. <b>NOTE:</b> An inventory cannot have a size
     * of more than 54 slots so the maximum of rows for an inventory is {@code 6}. If try to create
     * an page with more than 6 rows an exception will be thrown as described in {@link
     * ZInventory#build(ZInventoryPage)}
     */
