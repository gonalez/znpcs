...
import ak.znetwork.znpcservers.npc.hologram.Hologram;
import ak.znetwork.znpcservers.npc.conversation.ConversationModel;
import ak.znetwork.znpcservers.npc.packet.AbstractPacket;
...
import static ak.znetwork.znpcservers.npc.NPCPath.PathInitializer;
...
public class NPC {
    ...
    public void onLoad() {
        ...
        if (npcPojo.getPathName() != null) {
            setPath(AbstractTypeWriter.find(npcPojo.getPathName()));
        }
     ...
     *
     * @return The current npc location.
     */
    public Location getLocation() {
        return getNpcPath() != null ?
                getNpcPath().getLocation().bukkitLocation() :
