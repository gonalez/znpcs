...
public enum NPCType {
    ...
    public static Object[] arrayToPrimitive(String[] strings, Method method) {
        ...
        for(int i = 0; i < methodParameterTypes.length; i++) {
            ...
            else if (methodParameterTypes[i] == float.class) newArray[i] = NumberUtils.createNumber(strings[i]).floatValue();
            else if (methodParameterTypes[i] == double.class) newArray[i] = NumberUtils.createNumber(strings[i]).doubleValue();
            else if (methodParameterTypes[i] == int.class) newArray[i] = NumberUtils.createNumber(strings[i]).intValue();
            else if (methodParameterTypes[i] == short.class) newArray[i] = NumberUtils.createNumber(strings[i]).shortValue();
            else if (methodParameterTypes[i] == long.class) newArray[i] = NumberUtils.createNumber(strings[i]).longValue();
